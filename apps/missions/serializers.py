...
class MissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Mission
        fields = [
            'id', 'title', 'description', 'client', 'agent', 'tags',
            'location', 'address', 'price', 'service_fee', 'status',
            'qr_code_token', 'qr_expires_at', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'client', 'qr_code_token', 'created_at', 'updated_at']
...
class MissionDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Mission
        fields = [
            'id', 'title', 'description', 'client_name', 'agent_name',
    ...
    def get_agent_name(self, obj):
        if obj.agent:
            return obj.agent.username or obj.agent.email
        return None
...
class MissionCreateSerializer(serializers.Serializer):
    ...
    is_confidential = serializers.BooleanField(
        default=False,
        required=False,
        error_messages={'invalid': 'La valeur confidentiel doit être vrai ou faux.'}
    )
